...
import 'package:daily_planner1/widgets/calender_screen.dart';
import 'package:daily_planner1/widgets/completed_widget.dart';
import 'package:daily_planner1/widgets/pending_widget.dart';
import 'package:daily_planner1/widgets/task_statistics.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  int _buttonIndex = 0;
  bool isDarkMode = false; // Biến để theo dõi chế độ sáng/tối
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          isDarkMode ? Colors.black : const Color.fromARGB(255, 251, 251, 251),
      appBar: AppBar(
        backgroundColor:
            isDarkMode ? Colors.grey[850] : Color.fromARGB(249, 113, 152, 220),
          ...
          children: <Widget>[
            const DrawerHeader(
              decoration: BoxDecoration(
                color: Color.fromARGB(249, 113, 152, 220),
              ),
              child: Text(
                'Menu',
                style: TextStyle(
            ...
            ListTile(
              ...
              title:
                  const Text('Thống kê', style: TextStyle(color: Colors.white)),
              onTap: () {
                Navigator.pop(context); // Close the drawer
                Navigator.push(
                  context,
            ...
            ListTile(
              ...
              onTap: () {
                setState(() {
                  isDarkMode = !isDarkMode; // Đổi trạng thái chế độ sáng/tối
                });
              },
            ),
          ],
